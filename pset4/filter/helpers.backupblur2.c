    ...
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            for (int h = -1; h <= 1; h++)
            {
                ...
                {
                    if (imageBuffer[i + h][j + w].rgbtRed == 0 && imageBuffer[i + h][j + w].rgbtGreen == 0 && imageBuffer[i + h][j + w].rgbtBlue == 0)
                    {
                        n = n - 1;
                    }
            ...
            float faverageGreen = (arrGreen[0] + arrGreen[1] + arrGreen[2] + arrGreen[3] + arrGreen[4] + arrGreen[5] + arrGreen[6] + arrGreen[7] + arrGreen[8]) / n;
            int averageGreen = round(faverageGreen);
            image[i][j].rgbtGreen = averageGreen;

            float faverageBlue = (arrBlue[0] + arrBlue[1] + arrBlue[2] + arrBlue[3] + arrBlue[4] + arrBlue[5] + arrBlue[6] + arrBlue[7] + arrBlue[8]) / n;
